<template>
  <div class="container">
    <div class = "form_dropdown">
      <h2>Dropdown</h2>
      <p>Pilih Provinsi, Kota, dan kecamatan anda.</p>
...
export default {
  data: () => ({
    ...
    data_lokasi: {
      ...
      'Jawa Timur': {
        'Kota Surabaya': ['Karang Pilang', 'Gayungsari', 'Wiyung'],
        'Kota Malang': ['Blimbing', 'Kedungkandang', 'Klojen', 'Lowokwaru', 'Sukun'],
        'Kota Jember': ['Bangsalsari', 'Kaliwates', 'Pakusari'],
...
.form_dropdown {
  ...
  width: 700px;
  margin-bottom: 10px;
  box-shadow: 0 5px 10px 3px brown;
  border-radius: 5px;
  text-align: center;
